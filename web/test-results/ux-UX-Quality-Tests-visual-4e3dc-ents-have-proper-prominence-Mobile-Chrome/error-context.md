...
- Name: ux.spec.ts >> UX Quality Tests >> visual hierarchy - important elements have proper prominence
- Location: tests/ux.spec.ts:53:3
...
Locator: locator('[placeholder*="Message"]')
Expected: visible
Timeout: 5000ms
